...
import { ClientPipelineWidget } from "@/components/contracts/ClientPipelineWidget";
...
export function PartnerClientStatusPanel({
  ...
  return (
    <div className="space-y-4 rounded-2xl border border-zinc-800/80 bg-zinc-900/40 p-4 lg:p-5">
      ...
      >
        <p className="mb-3 text-sm font-medium text-zinc-200">고객사 소개 등록</p>
        ...
        <table className="w-full min-w-[720px] text-sm">
          <thead>
            <tr className="border-b border-zinc-800 bg-zinc-950/60 text-left text-xs text-zinc-500">
              <th className="px-3 py-2.5 font-medium">소개일</th>
          ...
          >
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-1 text-xs text-zinc-500">
                소개 {row.introducedAt} · {row.statusLabel}
              </p>
              {row.memo && (
